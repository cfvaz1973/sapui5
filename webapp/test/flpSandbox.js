		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tutorial",
									"targetURL": "#futureviewfiorisapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"futureviewfiorisapui5-display": {
								"semanticObject": "futureviewfiorisapui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=futureview.fiori.sapui5",
									"url": sap.ui.require.toUrl("futureview/fiori/sapui5")
								}
							}
						}
					}
